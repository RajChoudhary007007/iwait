...
const Mywalletuser = () => (
  <>
    <Header />
    <div className="user-wllet-main-container">
      <div className="bg-color">
        <div className="heder-wallet-container">
          <div className="heding-wallet-cont">
            <h1>
        ...
        <div className="wallet-card-container">
          <div className="wallet-user-head">
            <h3 style={{ color: "#000" }}>User-Bank</h3>
            <h1>
              <FcPortraitMode />
            </h1>
          </div>
        ...
        <div className="transaction-history">
            ...
            <div className="transaction-history-home">
                <div className="transaction-history-item">
                    <img src={tranction} className="trans-images"/>
                ...
                {/* <div className="transaction-history-item">
                    <img src={tranction} className="trans-images"/>
                    <h4 style={{color:"rgb(64, 64, 150)", width:"24%"}}>Deewaker</h4>
                    <h4 style={{color:"rgb(64, 64, 150)"}}>19/8/2023</h4>
                    <h3 style={{color:"rgb(64, 64, 150)"}}>$4000</h3>
                </div> */}
            </div>
        </div>
